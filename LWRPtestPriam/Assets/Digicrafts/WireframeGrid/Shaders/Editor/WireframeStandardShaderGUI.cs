...
{
	internal class WireframeGridStandardShaderGUI : WireframeGridShaderGUI
{
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			// Wireframe			
			WireframePropertiesGUI(m_MaterialEditor,material);
...
//	}
	...
	static void SetMaterialKeywords(Material material, WorkflowMode workflowMode)
	{
		...
		bool shouldEmissionBeEnabled = ShouldEmissionBeEnabled (material.GetColor("_EmissionColor")) || ShouldEmissionBeEnabled (material.GetColor("_WireframeEmissionColor"));;
