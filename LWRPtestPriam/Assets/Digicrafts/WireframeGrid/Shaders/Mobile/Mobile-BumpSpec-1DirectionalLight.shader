...
Shader "Digicrafts/WireframeGrid/Mobile/Bumped Specular (1 Directional Light)" {
Properties {
...
SubShader { 
	...
	Cull [_WireframeCull]
CGPROGRAM
#pragma surface surf MobileBlinnPhong exclude_path:prepass noforwardadd halfasview novertexlights vertex:vert //alpha nolightmap
#pragma target 3.0
